...
def priceFilterPage(Request,mc,sc,br):
    ...
    if(option=="1"):
        ...
        max = 1000000
    if(mc=="All" and sc=="All" and br=="All"):
        data = Product.objects.filter(finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    elif(mc!="All" and sc=="All" and br=="All"):
        data = Product.objects.filter(maincategory=Maincategory.objects.get(name=mc),finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    elif(mc=="All" and sc!="All" and br=="All"):
        data = Product.objects.filter(subcategory=Subcategory.objects.get(name=sc),finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    elif(mc=="All" and sc=="All" and br!="All"):
        data = Product.objects.filter(brand=Brand.objects.get(name=br),finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    elif(mc!="All" and sc!="All" and br=="All"):
        data = Product.objects.filter(maincategory=Maincategory.objects.get(name=mc),subcategory=Subcategory.objects.get(name=sc),finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    elif(mc!="All" and sc=="All" and br!="All"):
        data = Product.objects.filter(maincategory=Maincategory.objects.get(name=mc),brand=Brand.objects.get(name=br),finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    elif(mc=="All" and sc!="All" and br!="All"):
        data = Product.objects.filter(brand=Brand.objects.get(name=br),subcategory=Subcategory.objects.get(name=sc),finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    else:
        data = Product.objects.filter(maincategory=Maincategory.objects.get(name=mc),brand=Brand.objects.get(name=br),subcategory=Subcategory.objects.get(name=sc),finalprice__gte=min,finalprice__lte=max).order_by("finalprice")
    maincategories = Maincategory.objects.all()
    subcategories = Subcategory.objects.all()
    brands = Brand.objects.all()
    return render(Request,"shop.html",{'data':data,'maincategories':maincategories,'subcategories':subcategories,'brands':brands,'mc':mc,'sc':sc,'br':br})
    ...
    if(Request.method=="POST"):
        ...
        if(mode=="COD"): 
            ...
            message =   """
                        ...
                        Now Track Your Order In Profile Section
                        Team : E-Cart
                        """
